...
class CompanyFundItemBlock extends StatelessWidget {
  final InvestmentFundCompany investmentFundCompany;
  final bool isLogged;
  // final bool have;

  const CompanyFundItemBlock({super.key, required this.investmentFundCompany,  this.isLogged = true
  });

  @override
  Widget build(BuildContext context) {

        var str = investmentFundCompany.created_at;
                    ...
                    children: [
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 6,),
                                  Text(
                                    '${investmentFundCompany.created_at}',
                                    style: ksmallGreyHeadingTextStyle.copyWith(
                                      fontSize: 12.sp,
                                      color: kPrimaryColor,
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                    '${investmentFundCompany.total_funds}'+' '+'ر.س',
                            ...
                            Text(
                                '${double.parse(investmentFundCompany.progress_percentage.toString()).toStringAsFixed(2)}%',
                      ...
                      Padding(
                        ...
                        child: LinearPercentIndicator(
                          ...
                          percent:double.parse(investmentFundCompany.progress_percentage.toString()) /100,
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                              '${investmentFundCompany.amount_received}'+' '+'ر.س',
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              children: [
                                DataItem(title: 'نوع الصندوق',subTitle: investmentFundCompany.category??'',),
                                SizedBox(height: 10,),
                                // DataItem(title: 'مدة الفرصة',subTitle: '${investmentFundCompany.duration_of_investment}',),
                                // SizedBox(height: 10,),
                          ...
                          Column(
                            children: [
                              ...
                              // DataItem(title: 'عائد الاستثمار',subTitle: '${'00'}',),
                              DataItem(title: 'مدة الفرصة',subTitle: '${investmentFundCompany.duration_of_investment}',),
