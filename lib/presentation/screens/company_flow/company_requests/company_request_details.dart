...
class CompanyRequestDetails extends StatefulWidget {
  ...
  const CompanyRequestDetails({super.key,required this.requestModel});

  @override
  State<CompanyRequestDetails> createState() => _CompanyRequestDetailsState();
}

class _CompanyRequestDetailsState extends State<CompanyRequestDetails> with TickerProviderStateMixin {
          ...
          Padding(
            ...
            child: ListView(
              ...
              children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                      '${widget.requestModel.totalFunds}'+' '+'ر.س',
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        DetailsItem(title: StringConstants.typeOfInvestment, subTitle:'${ widget.requestModel.category}' , icon: Icons.category,),
                        SizedBox(height: 30,),
                        DetailsItem(title:
                        'تاريخ إنشاء الصندوق',
                          subTitle: '${ widget.requestModel.createdAt}', icon: Icons.date_range,),
                        // Row(
                        //   children: [
                        //     DetailsItem(title: StringConstants.typeOfInvestment, subTitle:'${ widget.requestModel.category}' , icon: Icons.category,),
                        //     SizedBox(width: 10,),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          width: MediaQuery.of(context).size.width*0.7,
                          child: Text(
                              '${widget.requestModel.purposeOfFunding}',
                              style: kSubtitleTextStyle.copyWith(fontSize: 14,)),
                        ),
                      ],
                    ),
                ...
                widget.requestModel.documents != null?
                Container(
                  decoration: BoxDecoration(
                      color: kWhiteColor,
                      borderRadius: BorderRadius.circular(16.r)
                  ...
                  child: Padding(
                      ...
                      child: ListView.builder(
                          shrinkWrap: true,
                          itemCount: widget.requestModel.documents?.length,
                            ...
                            children: [
                              InkWell(
                                onTap: (){
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) =>  DocumentPdfScreen(pdf:widget.requestModel.documents?[index]??'' ,userType: UserType.company)),
                                  );
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 10,),
                                        Text(
                                            '${widget.requestModel.document_names?[index]}',
                              ...
                              index  ==  (widget.requestModel.documents!.length) -1   ? SizedBox(): Padding(
                                padding: const EdgeInsets.symmetric(vertical:16.0),
                                child: Divider(color: Color(0xD5F1F1F1),thickness: 2.0,),
                              )
